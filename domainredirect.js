...
if (href.indexOf("&redirected") != -1 ) {
    ...
    var redirectMessage = "<p>You've been redirected from swan.mobius.umsystem.edu or swan.missouri.edu. Starting in June of 2012, those addresses will no longer work.</p><p>Please update your bookmarks to <a href='" + newURL + "'>" + newURL + "</a>.</p>"
